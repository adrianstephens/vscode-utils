...
import {Uri, ThemeColor, ThemeIcon, ColorThemeKind, window as vscodeWindow } from 'vscode';
...
type ColorType0	= string | ThemeColor;
...
function currentlyLight() {
	return vscodeWindow.activeColorTheme.kind === ColorThemeKind.Light || vscodeWindow.activeColorTheme.kind === ColorThemeKind.HighContrastLight;
}
...
function getColor(col: ColorType0) {
	const id	= col instanceof ThemeColor ? (col as any).id : col;
